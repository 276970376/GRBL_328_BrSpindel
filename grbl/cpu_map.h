...
#ifdef CPU_MAP_ATMEGA328P_ESC  // BlueOrangeLive
...
// begin BlueOrangeLive
      ...
      #define SPINDLE_TCCRB_INIT_MASK   ((SPINDLE_TCCRB_REGISTER & 0b11111000) | 0x05) // << 488Hz 0X05 set to 1/8 Prescaler
      #else
        #define SPINDLE_TCCRB_INIT_MASK (1<<CS21) // oder ca. 7.8kHz 
    #endif
// end BlueOrangeLive
    // NOTE: On the 328p, these must be the same as the SPINDLE_ENABLE settings.
    #define SPINDLE_PWM_DDR	  DDRB
