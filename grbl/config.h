...
#define DEFAULTS_ESC_BRSPINDEL
// #define CPU_MAP_ATMEGA328P // Arduino Uno CPU - Standart
#define CPU_MAP_ATMEGA328P_ESC // Arduino Uno CPU mit Brushless Spindel Motor on 488Hz - BlueOrangeLive
